...
1. Ознакомьтесь с основной информацией:
   ...
   * [Системные требования](/on-premise-citylens/install/requirements)
...
4. Убедитесь, что удовлетворены требования к ресурсам, приведённые в Helm-чартах:
   ...
   * [CityLens Routes UI](https://github.com/2gis/on-premise-helm-charts/blob/master/charts/citylens-routes-ui/values.yaml).
   ...
   Подробнее о том, как это сделать, см. в документе [Системные требования](/on-premise-citylens/install/requirements).
...
После установки <Brand /> Ситискан в вашем контуре и настройки доступов конечные пользователи могут начать работу с продуктом.

Подробные инструкции см. в [Руководстве пользователя](/citylens/overview).
