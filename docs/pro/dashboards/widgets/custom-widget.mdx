...
6. Введите URL источника или исходный код для HTML-элемента, который будет отображаться в виджете. Если вы указали URL, подключите Penpal и установите соединение с приложением: подробнее см. в разделе [Ссылка](#link).
7. Нажмите **Создать**.
