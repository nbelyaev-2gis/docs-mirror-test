...
* Добавлен [DGis.initialize](/android/sdk/reference/10.4/ru.dgis.sdk.DGis) с параметром для переопределения аудиодрайвера для воспроизведения звуков SDK. Добавлен интерфейс [AudioDriver](/android/sdk/reference/10.4/interface#ru.dgis.sdk.platform.audio-driver) для задания платформенной реализации аудиодрайвера.
...
* В [DGis.initialize](/android/sdk/reference/10.0/ru.dgis.sdk.DGis) добавлена возможность переопределения сетевого клиента с помощью интерфейса [HttpClient](/android/sdk/reference/10.0/interface#ru.dgis.sdk.platform.http-client).
