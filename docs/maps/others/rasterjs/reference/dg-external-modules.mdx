...
Кроме возможности подключить один из <a href="/ru/maps/others/rasterjs/reference/dg-loading#nav-lvl1--Опции_подключения">пакетов</a> модулей <Brand />,
...
<table>
    ...
    <tbody>
        <tr>
            <td><code>DG.plugin( <nobr>&lt;String&gt; <i>url</i> | </nobr> <nobr>&lt;Array&gt; <i>[&lt;String&gt; url, &lt;String&gt; url, ...]</i></nobr> ) </code></td>
