...
<table>
    ...
    <tbody>
        <tr>
            <td><code><b>addTo</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/map">Map</a>&gt; <i>map</i> </nobr>) </code></td>
            <td><code>this</code></td>
            <td>Добавляет объект входов на карту.</td>
        </tr>
        <tr>
            <td><code><b>removeFrom</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/map">Map</a>&gt; <i>map</i> </nobr>) </code></td>
            <td><code>this</code></td>
