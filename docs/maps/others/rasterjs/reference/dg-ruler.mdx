...
<table>
    ...
    <tbody>
        <tr>
            <td><code><b>DG.Ruler</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>[]&gt; <i>latlngs</i>,</nobr> <nobr>&lt;<a href="#dgruler-options">Ruler options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td><code><b>addTo</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/map#dgmap">Map</a>&gt; <i>map</i> </nobr>) </code></td>
        ...
        <tr>
            <td><code><b>addLatLng</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i> </nobr>) </code></td>
            <td><code>this</code></td>
            <td>Добавляет точку в линейку.</td>
        </tr>
        <tr>
            <td><code><b>setLatLngs</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>[]&gt; <i>latlngs</i> </nobr>) </code></td>
            <td><code>this</code></td>
        ...
        <tr>
            <td><code><b>spliceLatLngs</b>( <nobr>&lt;Number&gt; <i>index</i></nobr>, <nobr>&lt;Number&gt; <i>pointsToRemove</i></nobr>, <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng?</i>, … </nobr>) </code></td>
            <td><code><a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>[]</code></td>
