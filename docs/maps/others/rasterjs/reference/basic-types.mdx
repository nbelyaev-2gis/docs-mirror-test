...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Создает объект <a href="#nav-lvl1--DG.LatLngBounds"><code>LatLngBounds</code></a> на основе географических точек, которые находятся внутри описываемой области. Удобно использовать, если необходимо подстроить центр и масштаб карты с помощью метода <a href="/maps/others/rasterjs/reference/map#nav-lvl2--Методы_модификации_состояния_карты">fitBounds</a>.</td>
        </tr>
    </tbody>
</table>
