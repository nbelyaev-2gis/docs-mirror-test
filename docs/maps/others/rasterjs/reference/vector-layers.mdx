...
Не используйте этот класс напрямую. Расширяет <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Layer">Layer</a>.
...
<table id="dgpath-options">
    ...
    <tbody>
        ...
        <tr id="path-renderer">
            ...
            <td><code></code></td>
            <td>Использовать этот экземпляр <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Renderer"><code>Renderer</code></a> для данного векторного объекта. Переопределяет <a href="/maps/others/rasterjs/reference/map#map-renderer">renderer карты</a>, установленный по умолчанию.</td>
        </tr>
...
Опции, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dglayer-options">Layer</a> {/*  TODO: include options  */}

#### События

События, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dglayer-events">Layer</a> {/*  TODO: include events  */}

События попапа, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dglayer-popup-events">Layer</a> {/*  TODO: include popup events  */}
...
Методы попапа, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dglayer-popup-methods">Layer</a> {/*  TODO: include methods  */}

Методы, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dglayer-methods">Layer</a> {/*  TODO: include methods  */}

Методы, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dgevented-methods">Evented</a> {/*  TODO: include methods  */}
...
События попапов, унаследованные <a href="/maps/others/rasterjs/reference/base-classes#dglayer-popup-events">Layer</a> {/*  TODO: include popup events  */}
...
<table id="dgpolyline-methods">
    ...
    <tbody>
        ...
        <tr id="polyline-addlatlng">
            <td><code><b>addLatLng</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>) <nobr>&lt;LatLng[]&gt; <i>latlngs?</i></nobr>, </code></td>
            <td><code>this</code></td>
...
<table>
    ...
    <tbody>
        <tr id="rectangle-dg-rectangle">
            <td><code> <b>DG.rectangle</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds">LatLngBounds</a>&gt; <i>latLngBounds</i></nobr>, <nobr>&lt;Polyline options&gt; <i>options?</i></nobr>) </code></td>
            <td></td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id="rectangle-setbounds">
            <td><code><b>setBounds</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds">LatLngBounds</a>&gt; <i>latLngBounds</i></nobr>) </code></td>
            <td><code>this</code></td>
...
<table>
    ...
    <tbody>
        <tr id="circle-dg-circle">
            <td><code> <b>DG.circle</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>, <nobr>&lt;<a href="#dgpath-options">Path options</a>&gt; <i>options?</i></nobr>) </code></td>
        ...
        <tr id="circle-dg-circle-2">
            <td><code><b>DG.circle</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>, <nobr>&lt;Number&gt; <i>radius</i></nobr>, <nobr>&lt;<a href="#dgpath-options">Path options</a>&gt; <i>options?</i></nobr>) </code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id="circle-getbounds">
            <td><code><b>getBounds</b>()</code></td>
            <td><code><a href="/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds">LatLngBounds</a></code></td>
            <td>Возвращает <a href="/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds"><code>LatLngBounds</code></a> объекта.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id="circlemarker-dg-circlemarker">
            <td><code> <b>DG.circleMarker</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>, <i>options</i>)</code></td>
...
<table id="dgcirclemarker-methods">
    ...
    <tbody>
        ...
        <tr id="circlemarker-setlatlng">
            <td><code><b>setLatLng</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latLng</i></nobr>)</code></td>
            <td><code>this</code></td>
...
Наследуется от <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Renderer">Renderer</a>.
...
Опции, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#dgrenderer-options">Renderer</a> {/*  TODO: include options  */}
