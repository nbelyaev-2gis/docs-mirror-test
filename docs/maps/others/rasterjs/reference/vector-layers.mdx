...
Не используйте этот класс напрямую. Расширяет <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Layer">Layer</a>.
...
<table id="dgpath-options">
    ...
    <tbody>
        <tr id="path-stroke">
            ...
            <td>Нужно ли рисовать границу фигуры. Установите значение в <code>false</code>, чтобы отключить границы многоугольников или окружностей.</td>
        </tr>
        <tr id="path-color">
        ...
        <tr id="path-linecap">
            ...
            <td>Строка, которая определяет вид границы, <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/stroke-linecap"> на концах ломаной</a>.</td>
        </tr>
        <tr id="path-linejoin">
            <td><code><b>lineJoin</b></code></td>
            <td><code>String </code></td>
            <td><code>'round'</code></td>
            <td>Строка, которая определяет вид границы, <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/stroke-linejoin"> на изгибах</a> ломаной.</td>
        </tr>
        ...
        <tr id="path-dashoffset">
            ...
            <td><code>String </code></td>
            <td><code>null</code></td>
            <td>Строка, которая определяет <a href="https://developer.mozilla.org/docs/Web/SVG/Attribute/stroke-dashoffset">расстояние, через которое начинается штриховка</a>. Не работает на canvas слоях (например, Android 2).</td>
        </tr>
        <tr id="path-fill">
            <td><code><b>fill</b></code></td>
            <td><code>Boolean </code></td>
            <td><code>depends</code></td>
            <td>Заполнять ли фигуру цветом. Установите значение в <code>false</code>, чтобы отключить заполнение многоугольников или окружностей.</td>
        </tr>
        ...
        <tr id="path-fillrule">
            ...
            <td>Строка, которая задает, <a href="https://developer.mozilla.org/docs/Web/SVG/Attribute/fill-rule">как определяется внутренняя область фигуры</a>.</td>
        </tr>
        <tr id="path-interactive">
            <td><code><b>interactive</b></code></td>
            <td><code>Boolean </code></td>
            <td><code>true</code></td>
            <td>Если <code>false</code>, векторный слой не будет генерировать события мыши и будет вести себя, как часть нижележащего слоя карты.</td>
        </tr>
        <tr id="path-renderer">
            ...
            <td><code></code></td>
            <td>Использовать этот экземпляр <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Renderer"><code>Renderer</code></a> для данного векторного объекта. Переопределяет <a href="/ru/maps/others/rasterjs/reference/map#map-renderer">renderer карты</a>, установленный по умолчанию.</td>
        </tr>
...
Опции, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dglayer-options">Layer</a> {/*  TODO: include options  */}

#### События

События, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dglayer-events">Layer</a> {/*  TODO: include events  */}

События попапа, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dglayer-popup-events">Layer</a> {/*  TODO: include popup events  */}
...
<table id="dgpath-methods">
    ...
    <tbody>
        ...
        <tr id="path-setstyle">
            <td><code> <b>setStyle</b>( <nobr>&lt;<a href="#dgpath-options">Path options</a>&gt; <i>style</i></nobr>) </code></td>
            <td><code>this</code></td>
...
Методы попапа, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dglayer-popup-methods">Layer</a> {/*  TODO: include methods  */}

Методы, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dglayer-methods">Layer</a> {/*  TODO: include methods  */}

Методы, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dgevented-methods">Evented</a> {/*  TODO: include methods  */}

## DG.Polyline

Класс для отрисовки ломаных линий на карте. Расширяет <a href="#nav-lvl1--DG.Path">Path</a>.
...
<table>
    ...
    <tbody>
        <tr id="polyline-dg-polyline">
            <td><code><b>DG.polyline</b>( <nobr>&lt;LatLng[]&gt; <i>latlngs</i></nobr>, <nobr>&lt;<a href="#dgpath-options">Path options</a>&gt; <i>options?</i></nobr>) </code></td>
            <td>Создает объект ломаной по переданному массиву географических точек и необязательному объекту опций. Вы можете создать объект <a href="#nav-lvl1--DG.Polyline"><code>Polyline</code></a>, состоящий из множества линий (так называемый <code>MultiPolyline</code>), передав массив массивов географических точек.</td>
        </tr>
    </tbody>
</table>
...
<table id="dgpolyline-options">
    ...
    <tbody>
        <tr id="polyline-smoothfactor">
            ...
            <td><code>Number </code> </td><td><code>1.0</code></td>
            <td>Степень упрощения ломаной на каждом уровне масштаба. Большее значение означает более высокую производительность, но худшее качество, меньшее же значение — наоборот.</td>
        </tr>
        <tr id="polyline-noclip">
            <td><code><b>noClip</b></code></td>
            <td><code>Boolean: false</code> </td><td><code></code></td>
...
События попапов, унаследованные <a href="/ru/maps/others/rasterjs/reference/base-classes#dglayer-popup-events">Layer</a> {/*  TODO: include popup events  */}
...
<table id="dgpolyline-methods">
    ...
    <tbody>
        <tr id="polyline-togeojson">
            ...
            <td>Возвращает <a href="http://en.wikipedia.org/wiki/GeoJSON">GeoJSON</a> представление ломаной (GeoJSON LineString или <code>MultiLineString</code>).</td>
        </tr>
        ...
        <tr id="polyline-addlatlng">
            <td><code><b>addLatLng</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>) <nobr>&lt;LatLng[]&gt; <i>latlngs?</i></nobr>, </code></td>
            <td><code>this</code></td>
            <td>Добавляет точку в ломаную. По умолчанию, добавляет точку в первое звено списка ломаных в случае мультиломаной. Это поведение может быть переопределено передачей определенного звена, как массива элементов LatLng (к которому вы могли получить доступ ранее, с помощью метода <a href="#polyline-getlatlngs">getlatlngs</a>).</td>
        </tr>
    </tbody>
</table>
...
Класс для отрисовки многоугольников на карте. Расширяет <a href="#nav-lvl1--DG.Polyline">Polyline</a>.
...
<table>
    ...
    <tbody>
        <tr id="polygon-dg-polygon">
            <td><code> <b>DG.polygon</b>( <nobr>&lt;LatLng[]&gt; <i>latlngs</i></nobr>, <nobr>&lt;Polyline options&gt; <i>options?</i></nobr>) </code></td>
            <td></td>
        </tr>
    </tbody>
</table>
...
Класс для отрисовки прямоугольников на карте. Расширяет <a href="#nav-lvl1--DG.Polygon">Polygon</a>.
...
<table>
    ...
    <tbody>
        <tr id="rectangle-dg-rectangle">
            <td><code> <b>DG.rectangle</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds">LatLngBounds</a>&gt; <i>latLngBounds</i></nobr>, <nobr>&lt;Polyline options&gt; <i>options?</i></nobr>) </code></td>
            <td></td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id="rectangle-setbounds">
            <td><code><b>setBounds</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds">LatLngBounds</a>&gt; <i>latLngBounds</i></nobr>) </code></td>
            <td><code>this</code></td>
...
Класс для отрисовки окружности на карте. Расширяет <a href="#nav-lvl1--DG.Path">Path</a>. Это аппроксимация, которая начинает
...
<table>
    ...
    <tbody>
        <tr id="circle-dg-circle">
            <td><code> <b>DG.circle</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>, <nobr>&lt;<a href="#dgpath-options">Path options</a>&gt; <i>options?</i></nobr>) </code></td>
            <td>Создает объект круга по переданной географической точке и объекту опций, в котором содежится радиус круга.</td>
        </tr>
        <tr id="circle-dg-circle-2">
            <td><code><b>DG.circle</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>, <nobr>&lt;Number&gt; <i>radius</i></nobr>, <nobr>&lt;<a href="#dgpath-options">Path options</a>&gt; <i>options?</i></nobr>) </code></td>
            <td>Устаревший способ создания круга, только для совместимости со старым кодом. Не используйте его в своих новых приложениях и плагинах.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id="circle-radius">
            ...
            <td><code>Number</code> </td><td><code></code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id="circle-getbounds">
            <td><code><b>getBounds</b>()</code></td>
            <td><code><a href="/ru/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds">LatLngBounds</a></code></td>
            <td>Возвращает <a href="/ru/maps/others/rasterjs/reference/basic-types#nav-lvl1--DG.LatLngBounds"><code>LatLngBounds</code></a> объекта.</td>
        </tr>
    </tbody>
</table>
...
Окружность фиксированного размера с радиусом указанным в пикселях. Расширяет <a href="#nav-lvl1--DG.Path">Path</a>.
...
<table>
    ...
    <tbody>
        <tr id="circlemarker-dg-circlemarker">
            <td><code> <b>DG.circleMarker</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i></nobr>, <i>options</i>)</code></td>
...
<table id="dgcirclemarker-methods">
    ...
    <tbody>
        <tr id="circlemarker-togeojson">
            <td><code><b>toGeoJSON</b>()</code></td>
            <td><code>Object</code></td>
            <td>Возвращает <a href="http://en.wikipedia.org/wiki/GeoJSON">GeoJSON</a> представление круглого маркера (GeoJSON Point).</td>
        </tr>
        <tr id="circlemarker-setlatlng">
            <td><code><b>setLatLng</b>( <nobr>&lt;<a href="/ru/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latLng</i></nobr>)</code></td>
            <td><code>this</code></td>
...
Наследуется от <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Renderer">Renderer</a>.
...
SVG не доступен в IE8, но в этом браузере есть поддержка устаревшей технологии <a href="https://en.wikipedia.org/wiki/Vector_Markup_Language">VML</a>, и SVG renderer переключится на использование
...
Опции, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#dgrenderer-options">Renderer</a> {/*  TODO: include options  */}
...
<table>
    ...
    <tbody>
        <tr id="svg-create">
            ...
            <td>Возвращает экземпляр <a href="https://developer.mozilla.org/docs/Web/API/SVGElement">SVGElement</a>, соответствуйщий имени класса, переданному как аргумент. Например, использование 'line' вернет экземпляр <a href="https://developer.mozilla.org/docs/Web/API/SVGLineElement">SVGLineElement</a>.</td>
        </tr>
        <tr id="svg-pointstopath">
            <td><code> <b>pointsToPath</b>( <nobr>&lt;[]&gt; <i>rings</i>,</nobr> <nobr>&lt;Boolean&gt; <i>closed</i></nobr>) </code></td>
            <td><code>String</code></td>
            <td>Генерирует строку SVG path для множества звеньев, каждое звено превращается в "M..L..L.."-инструкции </td>
        </tr>
    </tbody>
</table>
