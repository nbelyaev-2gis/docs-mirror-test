...
<table>
    ...
    <tbody>
		<tr>
			<td><code><b>DG.Marker</b>( <nobr>&lt;<a href="/maps/others/rasterjs/reference/basic-types#dglatlng">LatLng</a>&gt; <i>latlng</i>,</nobr> <nobr>&lt;<a href="#опции">Marker options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id="marker-move">
            ...
            <td>Вызывается, когда маркер перемещается с помощью метода <a href="#marker-setlatlng"><code>setLatLng</code></a> или обычным <a href="#marker-dragging">перетаскиванием</a>. Старые и новые координаты попадают в аргументы события как <code>oldLatLng</code> и <a href="/maps/others/rasterjs/reference/basic-types#dglatlng"><code>latlng</code></a>.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr id="marker-dragend">
            ...
            <td><code><a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--Объекты_событий">DragEndEvent</a></code></td>
...
<table>
    ...
    <tbody>
	    ...
	    <tr id="marker-bindlabel">
	        <td><code><b>bindLabel</b>(&lt;String&gt; content, &lt;<a href="/maps/others/rasterjs/reference/dg-label#nav-lvl2--Опции">Label options</a>&gt; options?)</code></td>
            <td><code>this</code></td>
	    ...
	    <tr id="marker-showLabel">
	        ...
	        <td><code>this</code></td>
            <td>Показывает всплывающую подсказку (в случае использования опции <code><a href="/maps/others/rasterjs/reference/dg-label#label-static">static</a></code>).</td>
	    </tr>
