...
если не передана <a href="/maps/others/rasterjs/reference/map#map-zoomcontrol">опция <code>zoomControl</code></a> со значением <code>false</code>.
Расширяет <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control"><code>DG.Control</code></a>.
...
Опции, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control">Control</a> {/*  TODO: include options  */}

#### Методы

Методы, унаследованные от <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control">Control</a> {/*  TODO: include options  */}
...
если значение опции <a href="/maps/others/rasterjs/reference/map#map-attributioncontrol"><code>attributionControl</code></a>
не выставлено в <code>false</code>. Компонует итоговый текст из слоев, вызывая их метод <a href="/maps/others/rasterjs/reference/base-classes#layer-getattribution"><code>getAttribution</code></a>.
Расширяет <a href="/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control"><code>DG.Control</code></a>.
...
<table>
    ...
    <tbody>
        ...
        <tr id="control-scale-updatewhenidle">
            ...
            <td>При значении <code>true</code>, элемент будет обновляться только при возникновении события <a href="/maps/others/rasterjs/reference/map#map-moveend"><code>moveend</code></a>, в противном случае, при каждом событии <a href="/maps/others/rasterjs/reference/map#map-move"><code>move</code></a>.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr id="control-location-locateoptions">
            ...
            <td><code></code></td>
            <td>См. <a href="/maps/others/rasterjs/reference/map#nav-lvl1--Опции_определения_местоположения">geo-location options</a>.</td>
        </tr>
    </tbody>
</table>
