...
если не передана <a href="/ru/maps/others/rasterjs/reference/map#map-zoomcontrol">опция <code>zoomControl</code></a> со значением <code>false</code>.
Расширяет <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control"><code>DG.Control</code></a>.
...
<table>
    ...
    <tbody>
        <tr id="control-zoom-l-control-zoom">
            <td><code><b>DG.control.zoom</b>( <nobr>&lt;<a href="#control-zoom-option">DG.Control.Zoom options</a>&gt; <i>options</i> </nobr>) </code></td>
...
Опции, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control">Control</a> {/*  TODO: include options  */}

#### Методы

Методы, унаследованные от <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control">Control</a> {/*  TODO: include options  */}
...
если значение опции <a href="/ru/maps/others/rasterjs/reference/map#map-attributioncontrol"><code>attributionControl</code></a>
не выставлено в <code>false</code>. Компонует итоговый текст из слоев, вызывая их метод <a href="/ru/maps/others/rasterjs/reference/base-classes#layer-getattribution"><code>getAttribution</code></a>.
Расширяет <a href="/ru/maps/others/rasterjs/reference/base-classes#nav-lvl1--DG.Control"><code>DG.Control</code></a>.
...
<table>
    ...
    <tbody>
        <tr id="control-attribution-l-control-attribution">
            <td><code><b>DG.control.attribution</b>( <nobr>&lt;<a href="#control-attribution-option">DG.Control.Attribution options</a>&gt; <i>options</i> </nobr>) </code></td>
...
<table>
    <thead>
        <tr id="control-attribution-option">
            <th>Опция</th>
            <th>Тип</th>
            <th>Значение<br />>по умолчанию</th>
            <th>Описание</th>
    ...
    <tbody>
        <tr id="control-attribution-prefix">
            ...
            <td>Текст в формате HTML, который будет отображен перед информацией об авторстве. Для отключения необходимо передать <code>false</code>.</td>
        </tr>
    </tbody>
</table>
...
<table>
	...
	<tbody>
        ...
        <tr id="control-attribution-addattribution">
            ...
            <td><code>this</code></td>
            <td>Добавляет информацию об авторстве (например, <code>'Картографические данные <Brand />'</code>).</td>
        </tr>
...
<table>
    ...
    <tbody>
        <tr id="control-scale-l-control-scale">
            <td><code><b>DG.control.scale</b>( <nobr>&lt;<a href="#control-scale-option">DG.Control.Scale options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id="control-scale-updatewhenidle">
            ...
            <td>При значении <code>true</code>, элемент будет обновляться только при возникновении события <a href="/ru/maps/others/rasterjs/reference/map#map-moveend"><code>moveend</code></a>, в противном случае, при каждом событии <a href="/ru/maps/others/rasterjs/reference/map#map-move"><code>move</code></a>.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr id="control-ruler-l-control-ruler">
            <td><code><b>DG.control.ruler</b>( <nobr>&lt;<a href="#control-ruler-option">DG.Control.Ruler options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        <tr id="control-traffic-l-control-traffic">
            <td><code><b>DG.control.traffic</b>( <nobr>&lt;<a href="#control-traffic-option">DG.Control.Traffic options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        <tr id="control-fullscreen-l-control-fullscreen">
            <td><code><b>DG.control.fullscreen</b>( <nobr>&lt;<a href="#control-fullscreen-option">DG.Control.Fullscreen options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        <tr id="control-location-l-control-location">
            <td><code><b>DG.control.location</b>( <nobr>&lt;<a href="#control-location-option">DG.Control.LocationControl options</a>&gt; <i>options?</i> </nobr>) </code></td>
...
<table>
    ...
    <tbody>
        ...
        <tr id="control-location-follow">
            ...
            <td><code>Boolean </code></td>
            <td><code>false</code></td>
            <td>Динамическое обновление месторасположения пользователя, работает, если <code>watch</code> и <code>setView</code> выставлены в <code>true</code>.</td>
        </tr>
        ...
        <tr id="control-location-locateoptions">
            ...
            <td><code></code></td>
            <td>См. <a href="/ru/maps/others/rasterjs/reference/map#nav-lvl1--Опции_определения_местоположения">geo-location options</a>.</td>
        </tr>
    </tbody>
</table>
