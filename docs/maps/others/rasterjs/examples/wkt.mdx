...
Ниже приведены примеры работы с WKT. Для получения подробной информации перейдите см. раздел [WKT](/maps/others/rasterjs/reference/dg-wkt).

## Отображение простых векторных слоёв
...
<html>
    <head>
        ...
        <meta name="description" content="Отображение простых векторных слоёв" />
...
<html>
    <head>
        <title>RasterJS API</title>
        <meta name="description" content="Отображение составных векторных слоёв" />
        <script src="https://maps.api.2gis.ru/2.0/loader.js"></script>
    </head>
    <body>
        <div id="map" style="width: 100%; height: 400px"></div>
