...
1. Зарегистрируйтесь в личном кабинете [Менеджер Платформы](https://platform.2gis.ru/ru/?utm_source=docs&utm_medium=referral&utm_campaign=api_isochrone).
...
Чтобы получить данные о зоне доступности, отправьте POST-запрос на endpoint `/isochrone/2.0.0`. Для этого:
...
* Актуальные тарифы можно посмотреть в [Менеджере Платформы](https://platform.2gis.ru/ru/tariffs?utm_source=docs&utm_medium=referral&utm_campaign=api_isochrone).
