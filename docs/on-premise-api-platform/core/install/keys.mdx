...
1. По возможности познакомьтесь с:
   ...
   * [Системными требованиями](/on-premise-api-platform/core/install/requirements) к программному обеспечению и вычислительным ресурсам.
...
4. Убедитесь, что удовлетворены требования к ресурсам, приведённые в [Helm-чарте](https://github.com/2gis/on-premise-helm-charts/blob/master/charts/keys/values.yaml). Подробнее о том, как это сделать, см. в документе [Системные требования](/on-premise-api-platform/core/install/requirements).
...
1. Создайте конфигурационный файл для Helm. Подробное описание доступных параметров см. [здесь](https://github.com/2gis/on-premise-helm-charts/blob/master/charts/keys/README.md).
   ...
   * `tasker`: настройки сервиса Tasker, который выполняет административные задачи, связанные с API-ключами.
     ...
     * `resources`: настройки вычислительных ресурсов для сервиса. Чтобы узнать рекомендуемые значения ресурсов, см. [Вычислительные ресурсы](/on-premise-api-platform/core/install/requirements#resources).
...
* Установите продукты программного комплекса <Brand />:
  ...
  * [<Brand /> Про](/on-premise-pro/overview/summary),
  * [<Brand /> Ситискан](/on-premise-citylens/overview/summary),
  * [GIS-платформу](/on-premise-gis-platform/overview/summary).
