...
* На растровых тайлах отображается водяной знак с текстом, указанным в параметре `warningText` в [конфигурационном файле Tiles API](/on-premise-api-platform/api-platform/update/maps#update-tiles-api).
